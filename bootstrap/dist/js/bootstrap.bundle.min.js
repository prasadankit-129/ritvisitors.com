...
!(function(t, e) {
            ...
            if (f) f.oneOff = f.oneOff && o;
                ...
                var d = j(a, e.replace(O, "")),
                    ...
                    (function(t, e, n) {
                        return function i(o) {
                            for (
                                var r = t.querySelectorAll(e), s = o.target; s && s !== this; s = s.parentNode
                            )
    ...
    var Y = {
        ...
        q = {
            ...
            parents: function(t, e) {
                for (
                    var n = [], i = t.parentNode; i && i.nodeType === Node.ELEMENT_NODE && 3 !== i.nodeType;
            ...
            return (
                ...
                (r._setActiveIndicatorElement = function(t) {
                    if (this._indicatorsElement) {
                        for (
                            var e = q.find(".active", this._indicatorsElement), n = 0; n < e.length; n++
                        )
    ...
    H.on(
        ...
        H.on(window, "load.bs.carousel.data-api", function() {
            for (
                var t = q.find('[data-bs-ride="carousel"]'), e = 0, n = t.length; e < n; e++
            )
    ...
    var J = "collapse",
        ...
        nt = (function(t) {
            function o(e, n) {
                ...
                for (
                    var o = q.find('[data-bs-toggle="collapse"]'), r = 0, s = o.length; r < s; r++
                ) {
                    var a = o[r],
                        c = l(a),
    ...
    function kt(t) {
        ...
        return n && "body" === ft(n) && "static" === bt(n).position ?
            ...
            (function(t) {
                for (
                    var e = Et(t); pt(e) && ["html", "body"].indexOf(ft(e)) < 0;
    ...
    function qt(t, e, n) {
        var i =
            ...
            (function(t) {
                var e = Ut(Et(t)),
                    n = ["absolute", "fixed"].indexOf(bt(t).position) >= 0 && pt(t) ?
                    kt(t) :
                    t;
                return ht(n) ?
                    e.filter(function(t) {
            ...
            return (
                ...
                (o.dataApiKeydownHandler = function(t) {
                    if (!(/input|textarea/i.test(t.target.tagName) ?
                            ...
                            !pe.test(t.key)) &&
                        (t.preventDefault(),
                            t.stopPropagation(), !this.disabled && !this.classList.contains("disabled"))
                    ) {
                    ...
                    if (this._isShown && this._config.backdrop) {
                        if (
                            ((this._backdrop = document.createElement("div")),
                                ...
                                n && v(this._backdrop),
                                this._backdrop.classList.add("show"), !n)
                        )
                            return void t();
            ...
            return (
                ...
                (r.hide = function() {
                    ...
                    if (this._popper) {
                        ...
                        if (!H.trigger(this._element, this.constructor.Event.HIDE)
                            .defaultPrevented
                        ) {
                            var i;
                            if (
