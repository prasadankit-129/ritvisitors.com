        ...
        (function(a, b, c) {
            ...
            (c.serialize = function(a) {
                return null === a || void 0 === a ?
                    ...
                    ("number" == typeof a ?
                        (a = "" + a) :
                        "object" == typeof a && (a = JSON.stringify({
                            data: a
                        })),
            ...
            (c.normalizeData = function(a, b, d) {
                ...
                return (
                    (f.normalized.series = c.getDataArray({
                            series: a.series || []
                        },
                        b,
                        d
                    ...
                    Array.prototype.push.apply(
                        f.normalized.labels,
                        c
                        .times(Math.max(0, e - f.normalized.labels.length))
                        .map(function() {
                            return "";
                        })
                    ),
            ...
            (c.isDataHoleValue = function(a) {
                return (
                    null === a || void 0 === a || ("number" == typeof a && isNaN(a))
                );
            }),
            ...
            (c.getBounds = function(a, b, d, e) {
                ...
                var o = 2.221e-16;
                for (
                    k.step = Math.max(k.step, o), h = k.min, i = k.max; h + k.step <= k.low;
            ...
            (c.createLabel = function(a, d, e, f, g, h, i, j, k, l, m) {
                ...
                if (
                    ...
                    p.setAttribute("xmlns", c.namespaces.xhtml),
                        ...
                        (p.style[g.counterUnits.len] =
                            Math.round(o[g.counterUnits.len]) + "px"),
                        (n = j.foreignObject(
                            p,
                            c.extend({
        ...
        (function(a, b, c) {
            ...
            (c.Interpolation.none = function(a) {
                ...
                return (
                    ...
                    function(b, d) {
                        for (
                            var e = new c.Svg.Path(), f = !0, g = 0; g < b.length; g += 2
                        ) {
                            var h = b[g],
                                i = b[g + 1],
                                j = d[g / 2];
            ...
            (c.Interpolation.simple = function(a) {
                ...
                return function(b, e) {
                    for (
                        var f, g, h, i = new c.Svg.Path(), j = 0; j < b.length; j += 2
                    ) {
                        var k = b[j],
                            l = b[j + 1],
                            m = (k - f) * d,
                        ...
                        if (f.length) {
                            ...
                            for (m[0] = n[0], m[l - 1] = n[l - 2], h = 1; h < l - 1; h++)
                                ...
                                ((m[h] =
                                    ...
                                    isFinite(m[h]) || (m[h] = 0));
                            for (
                                i = new c.Svg.Path().move(j[0], k[0], !1, e[0]), h = 0; h < l - 1; h++
                            )
                                i.curve(
                                    j[h] + p[h] / 3,
                                    k[h] + (m[h] * p[h]) / 3,
            ...
            (c.Interpolation.step = function(a) {
                ...
                return (
                    ...
                    function(b, d) {
                        for (
                            var e, f, g, h = new c.Svg.Path(), i = 0; i < b.length; i += 2
                        ) {
                            var j = b[i],
                                k = b[i + 1],
                                l = d[i / 2];
        ...
        (function(a, b, c) {
            ...
            function d(a) {
                ...
                d.createGridAndLabels(
                    ...
                    c.createGridBackground(
                        g,
                        j,
                        a.classNames.gridBackground,
                        this.eventEmitter
                    ),
            ...
            function d(a) {
                ...
                a.horizontalBars ?
                    ((j = m =
                        ...
                        (l = n =
                            void 0 === a.axisY.type ?
                            new c.StepAxis(c.Axis.units.y, b.normalized.series, o, {
                                ticks: k,
                            }) :
                            a.axisY.type.call(
                                c,
                    ...
                    ((l = m =
                            void 0 === a.axisX.type ?
                            new c.StepAxis(c.Axis.units.x, b.normalized.series, o, {
                                ticks: k,
                            }) :
                            a.axisX.type.call(
                                c,
                                ...
                                b.normalized.series[e].forEach(
                                    function(g, k) {
                                        ...
                                        if (
                                            ...
                                            (v[l.units.pos + "2"] = r[l.units.pos]), !a.stackBars ||
                            ...
                            if (0 !== j.normalized.series[g] || !a.ignoreEmptyValues) {
                                ...
                                if (
                                    (y.attr({
                                        ...
                                        a.donut &&
                                        !a.donutSolid &&
                                        (y._node.style.strokeWidth = m.value + "px"),
                                        this.eventEmitter.emit("draw", {
                                            type: "slice",
                                    ...
                                    A =
                                        j.normalized.labels &&
                                        !c.isFalseyButZero(j.normalized.labels[g]) ?
