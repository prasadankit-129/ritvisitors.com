...
!(function(a, b) {
    "object" == typeof exports
        ?
        (module.exports = b()) :
        "function" == typeof define && define.amd && define("GMaps", [], b),
        (a.GMaps = b());
})(this, function() {
                ...
                d = function(b) {
                    ...
                    if (
                        ("string" == typeof b.el || "string" == typeof b.div ?
                            m.indexOf("#") > -1 ?
                            (this.el = h(m, b.context)) :
                            (this.el = g.apply(this, [m, b.context])) :
                            (this.el = m),
                    ...
                    for (
                        ...
                        delete b[l[e]];
                    for (
                        1 != b.disableDefaultUI && (A = a(A, B)), z = a(A, b), e = 0; e < j.length; e++
                    )
                        delete z[j[e]];
                    for (e = 0; e < k.length; e++) delete z[k[e]];
                    (this.map = new google.maps.Map(this.el, z)),
                    n && (this.markerClusterer = n.apply(this, [this.map]));
                    var C = function(a, b) {
                        var c = "",
                    ...
                    var G,
                        H = [];
                    for (G in this.map)
                        "function" != typeof this.map[G] || this[G] || H.push(G);
    ...
    (j.prototype.addMarker = function(a) {
        ...
        if (a.hasOwnProperty("gm_accessors_")) b = a;
            ...
            if (!((a.hasOwnProperty("lat") && a.hasOwnProperty("lng")) || a.position))
                throw "No latitude or longitude defined.";
    ...
    (j.prototype.removeOverlays = function() {
        for (var a, b = 0;
            (a = this.overlays[b]); b++) a.setMap(null);
        this.overlays = [];
    }),
    ...
    (j.prototype.removePolylines = function() {
        for (var a, b = 0;
            (a = this.polylines[b]); b++) a.setMap(null);
        this.polylines = [];
    }),
    ...
    (j.prototype.removePolygons = function() {
        for (var a, b = 0;
            (a = this.polygons[b]); b++) a.setMap(null);
        this.polygons = [];
    }),
    ...
    return (
            ...
            f.route(d, function(a, c) {
                if (c === google.maps.DirectionsStatus.OK) {
                    for (var d in a.routes)
                        a.routes.hasOwnProperty(d) && e.routes.push(a.routes[d]);
        ...
        (j.prototype.travelRoute = function(a) {
            if (a.origin && a.destination)
                this.getRoutes({
                    ...
                    callback: function(b) {
                        if (
                            ...
                            var c = b[b.length - 1];
                            if (c.legs.length > 0)
                                for (var d, e = c.legs[0].steps, f = 0;
                                    (d = e[f]); f++)
                ...
                for (var b, c = a.route.legs[0].steps, d = 0;
                    (b = c[d]); d++)
        ...
        (j.prototype.drawSteppedRoute = function(a) {
            ...
            if (a.origin && a.destination)
                this.getRoutes({
                    ...
                    callback: function(c) {
                        if (
                            ...
                            var d = c[c.length - 1];
                            if (d.legs.length > 0)
                                for (var e, f = d.legs[0].steps, g = 0;
                                    (e = f[g]); g++) {
                                    e.step_number = g;
                                    var h = {
                                        path: e.path,
                ...
                for (var c, d = a.route.legs[0].steps, e = 0;
                    (c = d[e]); e++) {
                    c.step_number = e;
                    var f = {
                        path: c.path,
        ...
        (j.createPanorama = function(b) {
            ...
            for (
                ...
                delete e[d[f]];
            for (
                var g = new google.maps.StreetViewPanorama(c, e), f = 0; f < d.length; f++
            )
                !(function(a, c) {
                    b[c] &&
                        google.maps.event.addListener(a, c, function() {
        ...
        (google.maps.Polygon.prototype.getBounds = function(a) {
            for (
                var b, c = new google.maps.LatLngBounds(), d = this.getPaths(), e = 0; e < d.getLength(); e++
            ) {
                b = d.getAt(e);
